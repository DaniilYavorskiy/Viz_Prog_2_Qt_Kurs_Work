/****************************************************************************
** Meta object code from reading C++ file 'girl.h'
**
...
#include "../../Cinema/girl.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'girl.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 41, 29) // "on_pushButton_tickets_clicked"
    ...
    "Girl\0afishaWindow\0\0on_pushButton_clicked\0"
...
void Girl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Girl::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Girl::afishaWindow)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Girl::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Girl.data,
