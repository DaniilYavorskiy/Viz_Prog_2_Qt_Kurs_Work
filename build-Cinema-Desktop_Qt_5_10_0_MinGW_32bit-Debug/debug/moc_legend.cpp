...
QT_MOC_LITERAL(4, 43, 29) // "on_pushButton_tickets_clicked"
    ...
    "Legend\0afishaWindow\0\0on_pushButton_clicked\0"
...
void Legend::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Legend::afishaWindow)) {
                *result = 0;
                return;
            }
        }
